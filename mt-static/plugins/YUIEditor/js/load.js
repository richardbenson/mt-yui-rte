function LoadYUI() {
	...
	document.write(unescape("%3Cscript src='" + ConfigYUIBase + "element/element-beta-min.js' type='text/javascript'%3E%3C/script%3E"));
	...
	document.write(unescape("%3Cscript src='" + ConfigYUIBase + "editor/editor-beta-min.js' type='text/javascript'%3E%3C/script%3E"));
